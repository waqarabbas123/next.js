...
pub async fn emit_unknown_module_type_error(source: Vc<Box<dyn Source>>) -> Result<()> {
    ModuleIssue {
        ...
        description: StyledString::Text(
            format!("The module \'{}\' doesn't have an associated type. Use a known file extension, or register a loader for it.

Read more: https://nextjs.org/docs/app/api-reference/next-config-js/turbo#webpack-loaders",  source.ident().to_string().await?).into(),
        )
        .resolved_cell(),
    }
    .resolved_cell()
